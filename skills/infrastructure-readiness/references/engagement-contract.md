# Infrastructure-readiness Engagement contract
...
Use when the user explicitly asks for the Infrastructure-readiness
perspective. Review the supplied focus as current-state operational material.
...
- Keep pre-existing operational concerns visible as advisories rather than
  treating them as proposal blockers.
...
- Use exact artifact evidence from the reviewed change and inspect surrounding
  material only for context.
